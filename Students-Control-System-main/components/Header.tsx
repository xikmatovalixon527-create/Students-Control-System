...
export function Header() {
  const openConfigModal = useStore(state => state.openConfigModal);
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-6 w-full sm:w-auto">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-surface hover:bg-border transition-colors text-xs font-medium py-2 px-4 rounded-full border border-border"
          >
